...
var list = function list(node) {
  ...
  return "<div class='storyList'>".concat(node === null || node === void 0 ? void 0 : (_node$data4 = node.data) === null || _node$data4 === void 0 ? void 0 : (_node$data4$target = _node$data4.target) === null || _node$data4$target === void 0 ? void 0 : (_node$data4$target$fi = _node$data4$target.fields) === null || _node$data4$target$fi === void 0 ? void 0 : (_node$data4$target$fi2 = _node$data4$target$fi.stories) === null || _node$data4$target$fi2 === void 0 ? void 0 : _node$data4$target$fi2.map(function (story) {
    var _story$fields, _story$fields$videoFi, _story$fields$videoFi2, _story$fields$videoFi3, _story$fields2, _story$fields2$videoF, _story$fields2$videoF2, _story$fields2$videoF3, _story$fields3, _story$fields3$videoF, _story$fields3$videoF2, _story$fields4, _story$fields4$thumbn, _story$fields4$thumbn2, _story$fields4$thumbn3, _story$fields5, _story$fields5$videoU, _story$fields6, _story$fields7, _story$fields8;

    var mpeg = story === null || story === void 0 ? void 0 : (_story$fields = story.fields) === null || _story$fields === void 0 ? void 0 : (_story$fields$videoFi = _story$fields.videoFile) === null || _story$fields$videoFi === void 0 ? void 0 : (_story$fields$videoFi2 = _story$fields$videoFi.fields) === null || _story$fields$videoFi2 === void 0 ? void 0 : (_story$fields$videoFi3 = _story$fields$videoFi2.videoUrls) === null || _story$fields$videoFi3 === void 0 ? void 0 : _story$fields$videoFi3['application/x-mpegURL'];
    ...
    var poster = story === null || story === void 0 ? void 0 : (_story$fields5 = story.fields) === null || _story$fields5 === void 0 ? void 0 : (_story$fields5$videoU = _story$fields5.videoUrls) === null || _story$fields5$videoU === void 0 ? void 0 : _story$fields5$videoU['image/jpeg'];
    return "<div class='story' data-title='".concat(story === null || story === void 0 ? void 0 : (_story$fields6 = story.fields) === null || _story$fields6 === void 0 ? void 0 : _story$fields6.title, "'\n                     data-slug='").concat(story === null || story === void 0 ? void 0 : (_story$fields7 = story.fields) === null || _story$fields7 === void 0 ? void 0 : _story$fields7.slug, "' \n                     data-published='").concat(story === null || story === void 0 ? void 0 : (_story$fields8 = story.fields) === null || _story$fields8 === void 0 ? void 0 : _story$fields8.publishedAt, "'\n                     ").concat(thumbnail ? "data-thumb='".concat(thumbnail, "'") : '', " \n                     ").concat(mp4 ? "data-mp4='".concat(mp4, "'") : '', "\n                     ").concat(mpeg ? "data-mpeg='".concat(mpeg, "'") : '', "\n                     ").concat(duration ? "data-duration='".concat(duration, "'") : '', "\n                     ").concat(poster ? "poster='".concat(poster, "'") : '', ">\n                  </div>");
  }).join(''), "</div>");
};
