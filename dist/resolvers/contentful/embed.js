...
var list = function list(node) {
  ...
  return "<div class='storyList'>".concat(node === null || node === void 0 ? void 0 : (_node$data4 = node.data) === null || _node$data4 === void 0 ? void 0 : (_node$data4$target = _node$data4.target) === null || _node$data4$target === void 0 ? void 0 : (_node$data4$target$fi = _node$data4$target.fields) === null || _node$data4$target$fi === void 0 ? void 0 : (_node$data4$target$fi2 = _node$data4$target$fi.stories) === null || _node$data4$target$fi2 === void 0 ? void 0 : _node$data4$target$fi2.map(function (story) {
    var _story$fields, _story$fields$videoUr, _story$fields$videoUr2, _story$fields2, _story$fields2$videoU, _story$fields2$videoU2, _story$fields3, _story$fields3$thumbn, _story$fields3$thumbn2, _story$fields3$thumbn3, _story$fields4, _story$fields5, _story$fields6, _story$fields7, _story$fields7$videoU;

    var mpeg = story === null || story === void 0 ? void 0 : (_story$fields = story.fields) === null || _story$fields === void 0 ? void 0 : (_story$fields$videoUr = _story$fields.videoUrls) === null || _story$fields$videoUr === void 0 ? void 0 : (_story$fields$videoUr2 = _story$fields$videoUr.fields) === null || _story$fields$videoUr2 === void 0 ? void 0 : _story$fields$videoUr2['application/x-mpegURL'];
    var mp4 = story === null || story === void 0 ? void 0 : (_story$fields2 = story.fields) === null || _story$fields2 === void 0 ? void 0 : (_story$fields2$videoU = _story$fields2.videoUrls) === null || _story$fields2$videoU === void 0 ? void 0 : (_story$fields2$videoU2 = _story$fields2$videoU.fields) === null || _story$fields2$videoU2 === void 0 ? void 0 : _story$fields2$videoU2['video/mp4'];
    ...
    return "<div class='story' data-title='".concat(story === null || story === void 0 ? void 0 : (_story$fields4 = story.fields) === null || _story$fields4 === void 0 ? void 0 : _story$fields4.title, "'\n                     data-slug='").concat(story === null || story === void 0 ? void 0 : (_story$fields5 = story.fields) === null || _story$fields5 === void 0 ? void 0 : _story$fields5.slug, "' \n                     data-published='").concat(story === null || story === void 0 ? void 0 : (_story$fields6 = story.fields) === null || _story$fields6 === void 0 ? void 0 : _story$fields6.publishedAt, "'\n                     ").concat(thumbnail ? "data-thumb='".concat(thumbnail, "'") : '', " \n                     ").concat(mp4 ? "data-mp4='".concat(mp4, "'") : '', "\n                     ").concat(mpeg ? "data-mpeg='".concat(mpeg, "'") : '', "\n                     ").concat(duration ? "data-duration='".concat(duration, "'") : '', "\n                     ").concat(poster ? "poster='".concat(story === null || story === void 0 ? void 0 : (_story$fields7 = story.fields) === null || _story$fields7 === void 0 ? void 0 : (_story$fields7$videoU = _story$fields7.videoUrls) === null || _story$fields7$videoU === void 0 ? void 0 : _story$fields7$videoU['image/jpeg'], "'") : '', ">\n                  </div>");
  }).join(''), "</div>");
};
